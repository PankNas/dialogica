  ...
  return (
    <Link
      ...
      className={mergeClassNames(
        'block text-center cursor-pointer px-6 py-2.5 bg-blue-600 font-semibold text-white rounded-xl transition-all duration-300 w-fit shadow-lg shadow-blue-500/20 whitespace-nowrap',
