      ...
      <Container className="py-3">
        <div className="flex items-center justify-between relative gap-8">
          ...
          <div className="hidden md:block">
            <ButtonLink href={`/#${FEEDBACK_ANCHOR}`}>Оставить заявку</ButtonLink>
          </div>
        ...
        <div
          ...
          className={mergeClassNames(
            ...
            bg-foreground border-b border-gray-800 shadow-lg
        ...
        >
          <div ref={menuContentRef} className="px-4">
            {/* Навигация */}
            ...
            {/* Кнопка */}
            <div className="pb-4">
              <ButtonLink href={`/#${FEEDBACK_ANCHOR}`} onClick={handleNavClick} className="w-full">
                Оставить заявку
              </ButtonLink>
            </div>
          </div>
